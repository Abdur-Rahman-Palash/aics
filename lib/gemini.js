...
7. Do NOT hallucinate, speculate, or invent any facts.
8. If the answer is not present in the context, say you do not know and direct the user to the contact form.
9. For task-based questions like "I want to create an invoice", find the relevant steps in the context and provide them clearly.
...
`;
  ...
  async generateUnrelatedResponse(userQuestion) {
    // Use the exact predefined message for unrelated questions
    return "I'm sorry, but I can only assist with questions related to this website and its services. If you need further assistance, please complete the contact form below. Once your request is submitted, our team will review it and send a response to your email. You may also receive an instant acknowledgment message confirming that your request has been successfully submitted.";
  }
