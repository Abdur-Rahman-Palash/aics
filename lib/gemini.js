...
class GeminiAI {
    ...
    async generateResponse(userMessage, context) {
        ...
        const systemPrompt = `You are a helpful customer support assistant. Use the following FAQ context to answer user questions. If you don't know the answer, politely ask them to clarify or offer to escalate to human support.
