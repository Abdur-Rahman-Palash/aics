...
class AICSChatWidget {
    ...
    async loadWidgetSettings() {
        try {
            ...
            // Ignore error - use default settings
        }
    }
    ...
    async sendMessage() {
        ...
        // Use REST API (works on Vercel and cross-origin embeds)
        try {
            const headers = { 'Content-Type': 'application/json' };
            // Don't use CSRF token or credentials for cross-origin chat requests to avoid issues
            ...
            this.hideTypingIndicator();
             ...
             console.error('[WIDGET] Error sending chat message:', error);
             this.hideTypingIndicator();
